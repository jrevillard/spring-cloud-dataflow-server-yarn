...
public class YarnPushApplication extends AbstractClientApplication<String, YarnPushApplication> {
  ...
  public String run(String... args) {
    ...
    if (cloudAppType == null) {
      throw new SpringApplicationException("Error executing a spring application",
          new IllegalArgumentException("cloudAppType must be set"));
    }
    ...
    return template.execute(new SpringApplicationCallback<String>() {
      ...
      public String runWithSpringApplication(ApplicationContext context) throws Exception {
        String deployerVersion =
            context.getEnvironment().getRequiredProperty("spring.cloud.deployer.yarn.version");
        org.apache.hadoop.conf.Configuration configuration =
            context.getBean(org.apache.hadoop.conf.Configuration.class);
        DefaultYarnCloudAppService defaultYarnCloudAppService =
            new DefaultYarnCloudAppService(deployerVersion);
